...
/**
 * This is the item provider adapter for a {@link performance.seff.ResourceDemandingSEFF} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceDemandingSEFFItemProvider extends IdentifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceDemandingSEFF_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceDemandingSEFF_owner_feature", "_UI_ResourceDemandingSEFF_type"),
				 SeffPackage.Literals.RESOURCE_DEMANDING_SEFF__OWNER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SeffPackage.Literals.RESOURCE_DEMANDING_SEFF__RESOURCE_DEMANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SeffPackage.Literals.RESOURCE_DEMANDING_SEFF__RESOURCE_DEMANDS,
