...
/**
 * This is the item provider adapter for a {@link reliability.seff.RecoveryActionBehaviour} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecoveryActionBehaviourItemProvider extends FailureHandlingEntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SeffPackage.Literals.RECOVERY_ACTION_BEHAVIOUR__FAILURE_HANDLING_ALTERNATIVES_RECOVERY_ACTION_BEHAVIOUR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 SeffFactory.eINSTANCE.createRecoveryAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 BehaviourseffFactory.eINSTANCE.createCollectionIteratorAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 BehaviourseffFactory.eINSTANCE.createExternalCallAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 BehaviourseffFactory.eINSTANCE.createAcquireAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 BehaviourseffFactory.eINSTANCE.createReleaseAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 BehaviourseffFactory.eINSTANCE.createSetVariableAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createStartAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createStopAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createInternalAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createBranchAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createForkAction()));

		newChildDescriptors.add
			(createChildParameter
				(seff.SeffPackage.Literals.BEHAVIOUR__STEPS_BEHAVIOUR,
				 seff.SeffFactory.eINSTANCE.createLoopAction()));
	}
