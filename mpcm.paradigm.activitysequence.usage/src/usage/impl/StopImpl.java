...
public class StopImpl extends AbstractUserActionImpl implements Stop {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UsagePackage.STOP___STOP_HAS_NO_SUCCESSOR__DIAGNOSTICCHAIN_MAP:
				return StopHasNoSuccessor((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
