 ...
 * @generated
 */
public class AllocationDomainPackageImpl extends EPackageImpl implements AllocationDomainPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see allocation.AllocationDomainPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AllocationDomainPackageImpl() {
		super(eNS_URI, AllocationDomainFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link AllocationDomainPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AllocationDomainPackage init() {
		if (isInited) return (AllocationDomainPackage)EPackage.Registry.INSTANCE.getEPackage(AllocationDomainPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredAllocationDomainPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AllocationDomainPackageImpl theAllocationDomainPackage = registeredAllocationDomainPackage instanceof AllocationDomainPackageImpl ? (AllocationDomainPackageImpl)registeredAllocationDomainPackage : new AllocationDomainPackageImpl();
		...
		theAllocationDomainPackage.createPackageContents();

		// Initialize created meta-data
		theAllocationDomainPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theAllocationDomainPackage,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return AllocationDomainValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theAllocationDomainPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AllocationDomainPackage.eNS_URI, theAllocationDomainPackage);
		return theAllocationDomainPackage;
	}
	 ...
	 * @generated
	 */
	public AllocationDomainFactory getAllocationDomainFactory() {
		return (AllocationDomainFactory)getEFactoryInstance();
	}
