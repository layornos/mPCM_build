...
/**
 * This is the item provider adapter for a {@link usage.ScenarioBehaviour} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioBehaviourItemProvider extends EntityItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR,
				 UsageFactory.eINSTANCE.createStart()));

		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR,
				 UsageFactory.eINSTANCE.createStop()));

		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR,
				 UsageFactory.eINSTANCE.createBranch()));

		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR,
				 UsageFactory.eINSTANCE.createLoop()));

		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR,
				 UsageFactory.eINSTANCE.createDelay()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return UsageEditPlugin.INSTANCE;
	}
