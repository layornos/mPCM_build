...
/**
 * This is the item provider adapter for a {@link usage.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends AbstractUserActionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsagePackage.Literals.LOOP__LOOP_ITERATION_LOOP);
			childrenFeatures.add(UsagePackage.Literals.LOOP__BODY_BEHAVIOUR_LOOP);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Loop.class)) {
			case UsagePackage.LOOP__LOOP_ITERATION_LOOP:
			case UsagePackage.LOOP__BODY_BEHAVIOUR_LOOP:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.LOOP__LOOP_ITERATION_LOOP,
				 VariablesFactory.eINSTANCE.createPCMRandomVariable()));

		newChildDescriptors.add
			(createChildParameter
				(UsagePackage.Literals.LOOP__BODY_BEHAVIOUR_LOOP,
				 UsageFactory.eINSTANCE.createScenarioBehaviour()));
	}
