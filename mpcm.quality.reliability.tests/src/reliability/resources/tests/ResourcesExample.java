/**
 */
package reliability.resources.tests;
...
public class ResourcesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.resources"));
				ReliabilityResourceRoot root = ResourcesFactory.eINSTANCE.createReliabilityResourceRoot();
