...
/**
 * This is the item provider adapter for a {@link repository.Protocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RepositoryPackage.Literals.PROTOCOL__PROTOCOL_TYPE_ID,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Protocol.class)) {
			case RepositoryPackage.PROTOCOL__PROTOCOL_TYPE_ID:
