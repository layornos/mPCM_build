 ...
 * </p>
 * <ul>
 *   <li>{@link composition.impl.ComposedStructureImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComposedStructureImpl extends EntityImpl implements ComposedStructure {
	...
	public EList<Containable> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<Containable>(Containable.class, this, CompositionPackage.COMPOSED_STRUCTURE__CONTENT);
		}
		return content;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositionPackage.COMPOSED_STRUCTURE__CONTENT:
