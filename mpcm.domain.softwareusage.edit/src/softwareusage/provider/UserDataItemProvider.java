...
/**
 * This is the item provider adapter for a {@link softwareusage.UserData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserDataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoftwareusagePackage.Literals.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoftwareusagePackage.Literals.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UserData.class)) {
			case SoftwareusagePackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoftwareusagePackage.Literals.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA,
