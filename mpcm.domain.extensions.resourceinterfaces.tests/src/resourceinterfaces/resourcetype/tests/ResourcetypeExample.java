...
public class ResourcetypeExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.resourcetype"));
				ResourceInterfaceResourcetypeRoot root = ResourcetypeFactory.eINSTANCE.createResourceInterfaceResourcetypeRoot();
